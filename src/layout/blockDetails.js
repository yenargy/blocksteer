...
// Utils
import { copyTextToClipboard, formatedTimeFrom } from '../utils';
...
function BlockDetails() {
  ...
  // Function to go to previous state using react router
  function goBack() {
    history.push("/");
  }
      ...
      <BlockDetailsCard>
        ...
        <BlockMetaDetailsContainer>
          ...
          <BlockMetaDetails>
            ...
            <p>{formatedTimeFrom(block.timestamp)} [{moment.unix(block.timestamp).format('Do MMM YYYY hh:mm:ss A zz')}]</p>
          </BlockMetaDetails>
        </BlockMetaDetailsContainer>
        <Divider />
